<h1>Terms and Conditions for {{ config('app.name') }}</h1>
<h2>Introduction</h2>
<p>These Website Standard Terms and Conditions written on this webpage
    shall manage your use of our website, {{ config('app.name') }} accessible at
    {{ config('app.url') }}.</p>
...
<p>Other than the content you own, under these Terms, {{ config('app.name') }} and/or
...
<p>Certain areas of this Website are restricted from being access by you
    and {{ config('app.name') }} may further restrict access by you to any areas of this
...
<h2>Your Content</h2>
<p>In these Website Standard Terms and Conditions, "Your Content" shall
    mean any audio, video text, images or other material you choose to
    display on this Website. By displaying Your Content, you grant
    {{ config('app.name') }} a non-exclusive, worldwide irrevocable, sub licensable
...
<p>Your Content must be your own and must not be invading any
    third-party’s rights. {{ config('app.name') }} reserves the right to remove any of
    Your Content from this Website at any time without notice.</p>
<h2>Your Privacy</h2>
<p>Please read Privacy Policy.</p>
<h2>No warranties</h2>
<p>This Website is provided "as is," with all faults, and {{ config('app.name') }}
...
<p>In no event shall {{ config('app.name') }}, nor any of its officers, directors and
    ...
    under contract. &nbsp;{{ config('app.name') }}, including its officers, directors and
...
<p>You hereby indemnify to the fullest extent {{ config('app.name') }} from and
...
<p>{{ config('app.name') }} is permitted to revise these Terms at any time as it sees
    fit, and by using this Website you are expected to review these Terms on
    a regular basis.</p>
<h2>Assignment</h2>
<p>The {{ config('app.name') }} is allowed to assign, transfer, and subcontract its
...
<p>These Terms constitute the entire agreement between {{ config('app.name') }} and
    you in relation to your use of this Website, and supersede all prior
    agreements and understandings.</p>
<h2>Governing Law &amp; Jurisdiction</h2>
<p>These Terms will be governed by and interpreted in accordance with
    the laws of the State of tr, and you submit to the non-exclusive
    jurisdiction of the state and federal courts located in tr for the
